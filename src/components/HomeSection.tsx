...
const HomeSection = () => {
    return (
        <section className="flex flex-col lg:flex-row justify-between items-center p-12 bg-gray-50 h-screen">
            ...
            <div className="flex-1 max-w-md flex items-center justify-center lg:justify-end">
                <Image src={chickenImage} alt="Delicious Chicken" className="w-full h-auto"/>
            </div>
        </section>
    );
};
